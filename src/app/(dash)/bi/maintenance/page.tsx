...
export const metadata: Metadata = { title: "Maintenance Analytics" };
...
export default async function MaintenanceAnalyticsPage() {
  ...
  return (
    <div style={{ padding: 24, display: "flex", flexDirection: "column", gap: 20 }}>
      <div>
        <h1 style={{ fontSize: 22, fontWeight: 700, color: "var(--text)", margin: 0 }}>Maintenance Analytics</h1>
        <p style={{ fontSize: 13, color: "var(--text-3)", marginTop: 4 }}>Machine availability, MTBF, work order trends and maintenance cost</p>
      </div>
      {!data ? (
